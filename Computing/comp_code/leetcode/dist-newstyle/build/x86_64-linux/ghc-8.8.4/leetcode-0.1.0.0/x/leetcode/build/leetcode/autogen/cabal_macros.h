...
/* package leetcode-0.1.0.0 */
#ifndef VERSION_leetcode
#define VERSION_leetcode "0.1.0.0"
#endif /* VERSION_leetcode */
#ifndef MIN_VERSION_leetcode
#define MIN_VERSION_leetcode(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_leetcode */
...
#define CURRENT_COMPONENT_ID "leetcode-0.1.0.0-inplace-leetcode"
